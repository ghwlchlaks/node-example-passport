...
router.post('/', function(req,res){
	res.render('../../../../../var/www/html/archived/captureURL',{url : 'asd' /*req.body.url*/});
//	console.log('url :' req.body.url);

});

//
//router.get('/login', captureController.getShareImage)
/*router.get('/login', function(req, res, next){
	res.render('share', {image : captureController.getShareImage.image});
});*/
//
